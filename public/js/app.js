...
function updateCart(cupcake) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', cupcake).then(function (res) {
    console.log(res);
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    console.log(e);
    var cupcake = JSON.parse(btn.dataset.cupcake);
    updateCart(cupcake); // console.log(pizza)
  });
...
(0,_admin__WEBPACK_IMPORTED_MODULE_2__["default"])(); //Dynamic status Changing
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcakery"] = self["webpackChunkcakery"] || [];
